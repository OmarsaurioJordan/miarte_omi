...
para editar los datos de autor

1. modifique manualmente autor.json
...
2. ejecutar codigo/main.py
3. ir a "editar" allí podrá elegir uno de los dibujos de la galería de carpetas seleccionables, se abrirán sus metadatos
...
1. si quiere crear o eliminar un grupo debe crear o eliminar la carpeta del sistema, en miarte/
2. ejecutar codigo/main.py
3. ir a "grupos" allí verá las diferentes carpetas que existen, seleccione una
4. edite los metadatos
5. pulse "guardar"
...
- la UI muestra una interfaz con título, un texto "acerca de" y 4 botónes (nuevo, editar, grupos y generar)
- nuevo lleva a la UI arte_nuevo.py
- editar lleva a la UI arte_edita.py
- grupos lleva a la UI grupo_edita.py
...
- para cargar imágenes pulsar un botón, que abra un selector de archivos múltiples, con formatos (png, jpg, jpeg, gif, bmp, webm), las imágnees cargadas aparecerán en la interfaz pero aún no se moverán o copiarán archivos, por defecto abre la carpeta origen/
- poder eliminar imágenes cargadas y seleccionadas en la interfaz, solo desvincula el archivo de la UI, no lo elimina como tal
- poder mover arriba abajo el órden de las imágenes importadas, usando dos botónes
...
- botón de guardar, en caso de haber al menos una imágen seleccionada, corta y pega las imágenes en la carpeta establecida y agrega los metadatos al data.json de esa carpeta, muestra un mensaje de lo logrado y si salió bien limpia la interfaz

### codigo/arte_edita

- una interfaz UI de edición, primero muestra una lista de series de imágenes en la carpeta actual, y un selector permite cambiar de carpeta dentro de miarte/
- para cargar imágenes pulsar un botón, que abra un selector de archivos múltiples, con formatos (png, jpg, jpeg, gif, bmp, webm), las imágnees cargadas aparecerán en la interfaz pero aún no se moverán o copiarán archivos, por defecto abre la carpeta origen/
- poder eliminar imágenes cargadas y seleccionadas en la interfaz, solo desvincula el archivo de la UI, no lo elimina como tal
- poder mover arriba abajo el órden de las imágenes importadas, usando dos botónes
...
- series - array (para referirse a las series que tiene almacenadas)
